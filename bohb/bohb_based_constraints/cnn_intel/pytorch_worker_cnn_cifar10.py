...
class PyTorchWorker(Worker):
    def __init__(self, N_train=12000, N_valid=2000, num_epoch=100, **kwargs):
        ...
        self.train_dataset = datasets.ImageFolder(train_dir, transform=transf)
        self.test_dataset = datasets.ImageFolder(test_dir, transform=transf)
    ...
    def compute(self, config_id, config, budget, working_directory, *args, **kwargs):
        ...
        if training_time > 500: # or megabytes_of_model > 20:
            loss = np.inf
        else:
