...
all_results_1 = np.load('./all_results_10_1.npy', allow_pickle=True)
all_results_2 = np.load('./all_results_5_2.5.npy', allow_pickle=True)
all_results_1 = np.delete(all_results_1, 0, 0)
all_results_2 = np.delete(all_results_2, 0, 0)

all_results = np.vstack((all_results_1, all_results_2))
