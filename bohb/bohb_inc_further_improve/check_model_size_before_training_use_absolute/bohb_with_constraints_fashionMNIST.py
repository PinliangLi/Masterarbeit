...
parser.add_argument('--min_budget',   type=float, help='Minimum budget of training data for training.',    default=256)
parser.add_argument('--max_budget',   type=float, help='Maximum budget of training data for training.',    default=8192)
...
from pytorch_worker_cnn_fashionMNIST_incremental import PyTorchWorker as worker
