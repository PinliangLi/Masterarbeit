...
parser.add_argument('--min_budget',   type=float, help='Minimum budget of training data for training.',    default=1000)
parser.add_argument('--max_budget',   type=float, help='Maximum budget of training data for training.',    default=40000)
...
from pytorch_worker_cnn_cifar10_incremental_before_abs import PyTorchWorker as worker
