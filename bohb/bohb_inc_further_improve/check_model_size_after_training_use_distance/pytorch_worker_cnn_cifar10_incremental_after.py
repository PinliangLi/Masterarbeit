...
class PyTorchWorker(Worker):
    ...
    def compute(self, config_id, config, budget, working_directory, *args, **kwargs):
        ...
        #if training_time > 25: #or megabytes_of_model > 20:
        #    loss = 1 - validation_accuracy
        #    if training_time > 25:
        #        loss += training_time - 25
        #    #elif megabytes_of_model > 20:
        #    #    loss += megabytes_of_model - 20

        if megabytes_of_model > 500:
            loss = 1 - validation_accuracy
            loss += megabytes_of_model - 500
