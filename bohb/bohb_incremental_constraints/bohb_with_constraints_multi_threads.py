...
from bohb.bohb_based_constraints.pytorch_worker_cnn_cifar10 import PyTorchWorker as worker
...
constraint_results = [np.inf, 0, 0, 0, 0, 0, 0]
running_results = [0, 0, 0, 0, 0, 0, 0]
...
for i in range(args.n_workers):
    w = worker(run_id=args.run_id, host=host, nameserver=ns_host, nameserver_port=ns_port, timeout=120, id=i)
