...
class PyTorchWorker(Worker):
    ...
    def compute(self, config_id, config, budget, working_directory, *args, **kwargs):
        ...
        if not status_file.is_file():
            ...
            train_data, valid_data = train_test_split(self.train_dataset, train_size=(budget_data_num - already_used_data_num),
        ...
        if training_time > 0.5: # or megabytes_of_model > 0.5:
            loss = np.inf
        else:
