...
re = np.load('./running_results_incremental_cnn_MNIST_5_0.5.npy', allow_pickle=True)
print(re)
re = np.delete(re, 0, 0)
best_result = re[-1, :]
print("best result:")
print("loss: ", best_result[0])
print("test accurancy: ", best_result[2])
print("training time:", best_result[3])
print("record time:", best_result[4])
print("size of model: ", best_result[5])
print("config: ", best_result[6])
print("budget:", best_result[7])
