...
results_bohb = np.load('./running_results_based_cnn6_cifar10_500_10_1.npy', allow_pickle=True)
results_bohb = np.delete(results_bohb, 0, 0)
best_result_bohb = results_bohb[-1, :]

results_bohb_incremental = np.load('./running_results_inc_cnn6_cifar10_500_10_1.npy', allow_pickle=True)
...
o_results = np.load('./running_results_bo_cnn6_cifar_500_50_1.npy', allow_pickle=True)
o_re = np.delete(o_results, 0, 0)
n_results = np.load('./running_results_new_cnn6_cifar10_500_10_1.npy', allow_pickle=True)
...
ax.set_title("compare methods with constraint training time 500s and model size 10MB _2")  # Add a title to the axes.
ax.legend()
plt.show()
