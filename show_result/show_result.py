...
results_bohb = np.load('./running_results_based_cnn_MNIST_10_1.npy', allow_pickle=True)
results_bohb = np.delete(results_bohb, 0, 0)
best_result_bohb = results_bohb[-1, :]

results_bohb_incremental = np.load('./running_results_incremental_cnn_MNIST_10_1.npy', allow_pickle=True)
results_bohb_incremental = np.delete(results_bohb_incremental, 0, 0)
best_result_bohb_incremental = results_bohb_incremental[-1, :]

results_bohb_meta = np.load('./running_results_inc_and_meta_cnn_MNIST_10_1.npy', allow_pickle=True)
...
o_results = np.load('./running_results_origin_cnn_MNIST_10_1.npy', allow_pickle=True)
o_re = np.delete(o_results, 0, 0)
n_results = np.load('./running_results_aggregation_cnn_MNIST_10_1.npy', allow_pickle=True)
...
ax.set_title("compare methods with constraint training time 10s and model size 1MB")  # Add a title to the axes.
ax.legend()
plt.show()
