...
results_bohb_1 = np.load('./running_results_based_250_50.npy', allow_pickle=True)
results_bohb_1 = np.delete(results_bohb_1, 0, 0)
best_result_bohb_1 = results_bohb_1[-1, :]

results_bohb_2 = np.load('./running_results_based_250_50_1.npy', allow_pickle=True)
results_bohb_2 = np.delete(results_bohb_2, 0, 0)
best_result_bohb_2 = results_bohb_2[-1, :]

results_bohb_3 = np.load('./running_results_based_250_50_2.npy', allow_pickle=True)
results_bohb_3 = np.delete(results_bohb_3, 0, 0)
best_result_bohb_3 = results_bohb_3[-1, :]


results_bohb_incremental_1 = np.load('./running_results_inc_250_50.npy', allow_pickle=True)
...
results_bohb_incremental_2 = np.load('./running_results_inc_250_50_1.npy', allow_pickle=True)
...
results_bohb_incremental_3 = np.load('./running_results_inc_250_50_2.npy', allow_pickle=True)
...
# results_bohb_inc_meta_1 = np.load('./running_results_meta_250_50.npy', allow_pickle=True)
# results_bohb_inc_meta_1 = np.delete(results_bohb_inc_meta_1, 0, 0)
# results_bohb_inc_meta_1 = results_bohb_inc_meta_1[-1, :]
#
# print(results_bohb_inc_meta_1)
#
# results_bohb_inc_meta_2 = np.load('./running_results_meta_250_50_1.npy', allow_pickle=True)
# results_bohb_inc_meta_2 = np.delete(results_bohb_inc_meta_2, 0, 0)
# results_bohb_inc_meta_2 = results_bohb_inc_meta_2[-1, :]
#
# results_bohb_inc_meta_3 = np.load('./running_results_meta_250_50_2.npy', allow_pickle=True)
# results_bohb_inc_meta_3 = np.delete(results_bohb_inc_meta_3, 0, 0)
# results_bohb_inc_meta_3 = results_bohb_inc_meta_3[-1, :]
...
o_results_1 = np.load('./running_results_bo_cnn6_cifar10_250_50.npy', allow_pickle=True)
o_re_1 = np.delete(o_results_1, 0, 0)

o_results_2 = np.load('./running_results_bo_cnn6_cifar10_250_50_1.npy', allow_pickle=True)
o_re_2 = np.delete(o_results_2, 0, 0)

o_results_3 = np.load('./running_results_bo_cnn6_cifar10_250_50_2.npy', allow_pickle=True)
o_re_3 = np.delete(o_results_3, 0, 0)

n_results_1 = np.load('./running_results_new_cnn6_cifar10_250_50.npy', allow_pickle=True)
n_re_1 = np.delete(n_results_1, 0, 0)

n_results_2 = np.load('./running_results_new_cnn6_cifar10_250_50_1.npy', allow_pickle=True)
n_re_2 = np.delete(n_results_2, 0, 0)

n_results_3 = np.load('./running_results_new_cnn6_cifar10_250_50_2.npy', allow_pickle=True)
...
# ax.plot(x_inc_meta_time, y_inc_meta_test_acc, 'bv-', label='bohb_with_constraint_meta')
