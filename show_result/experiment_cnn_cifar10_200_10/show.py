...
for i in exp_num:
    ...
    new_method_file = './running_results_new_cnn6_cifar_200_10_' + str(i) + '.npy'
    ...
    results_bohb_inc_meta_file = './running_results_inc_and_meta_200_10_' + str(i) + '.npy'
    ...
    results_before_trains_file = './running_results_before_200_10_' + str(i) + '.npy'
    ...
    results_before_trains_abs_file = './running_results_before_abs_200_10_' + str(i) + '.npy'
    ...
    results_use_distances_file = './running_results_dist_200_10_' + str(i) + '.npy'
...
fig.suptitle('compare methods with constraint training time 200s and model size 10MB')
