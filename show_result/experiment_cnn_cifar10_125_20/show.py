...
for i in exp_num:
    ...
    new_method_file = './running_results_new_cnn6_cifar_125_20_' + str(i) + '.npy'
    ...
    results_bohb_inc_meta_file = './running_results_inc_and_meta_125_20_' + str(i) + '.npy'
    ...
    results_before_trains_file = './running_results_before_125_20_' + str(i) + '.npy'
    ...
    results_before_trains_abs_file = './running_results_before_abs_125_20_' + str(i) + '.npy'
    ...
    results_use_distances_file = './running_results_dist_125_20_' + str(i) + '.npy'
...
fig.suptitle('compare methods with constraint training time 125s and model size 20MB')
