...
for i in exp_num:
    ...
    new_method_file = './running_results_new_cnn_MNIST_1.5_0.5_' + str(i) + '.npy'
    ...
    results_bohb_inc_meta_file = './running_results_inc_and_meta_1.5_0.5_' + str(i) + '.npy'
    ...
    results_before_trains_file = './running_results_before_1.5_0.5_' + str(i) + '.npy'
    ...
    results_before_trains_abs_file = './running_results_before_abs_1.5_0.5_' + str(i) + '.npy'
    ...
    results_use_distances_file = './running_results_dist_1.5_0.5_' + str(i) + '.npy'
...
fig.suptitle('compare methods with constraint training time 1.5s and model size 0.5MB')
