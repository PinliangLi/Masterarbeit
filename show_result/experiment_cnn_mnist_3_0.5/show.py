...
for i in exp_num:
    ...
    new_method_file = './running_results_new_cnn_MNIST_3_0.5_' + str(i) + '.npy'
    ...
    results_bohb_inc_meta_file = './running_results_mnist_inc_meta_3_0.5_' + str(i) + '.npy'
    ...
    results_before_trains_file = './running_results_mnist_before_3_0.5_' + str(i) + '.npy'
    ...
    results_before_trains_abs_file = './running_results_mnist_before_abs_3_0.5_' + str(i) + '.npy'
    ...
    results_use_distances_file = './running_results_mnist_dist_3_0.5_' + str(i) + '.npy'
...
fig.suptitle('compare methods with constraint training time 3s and model size 0.5MB')
