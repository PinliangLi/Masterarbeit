...
def evaluate(params):
    ...
    if training_time < 1.5:
        constraint_value = constraint_value + (training_time - 1.5)
...
if __name__ == '__main__':
    ...
    for _ in range(n_iterations + 1):
        ...
        new_config = [round(X_new[0][0]), round(X_new[0][1]), round(X_new[0][2]), round(X_new[0][3]),
                      round(X_new[0][4]), X_new[0][5], X_new[0][6], X_new[0][7]]
    ...
    np.save('./running_results_new_cnn_MNIST_1.5_0.5_log_1.npy', record_results)
