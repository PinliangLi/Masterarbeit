...
def evaluate(params):
    ...
    validation_sampler = torch.utils.data.sampler.SubsetRandomSampler(range(config['num_training_data'], config['num_training_data'] + 5000))
...
if __name__ == '__main__':
    ...
    init_c_training_time = init_c_training_time - 250
    init_c_model_size = init_c_model_size - 50
    ...
    for _ in range(n_iterations + 1):
        ...
        c_training_time = c_training_time - 250
        c_model_size = c_model_size - 50
        print(c_training_time, c_model_size)
        if (training_time < 250) and (model_size < 50):
    ...
    np.save('./running_results_bo_cnn6_cifar10_250_50_2.npy', record_results)
