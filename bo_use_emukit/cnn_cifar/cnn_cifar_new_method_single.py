...
def evaluate(params):
    ...
    if training_time < 25:
        constraint_value = constraint_value + (training_time - 25)
        satisfied_constraints = satisfied_constraints + 1

    if model_size < np.inf:
        # constraint_value = constraint_value + (model_size - 500)
        satisfied_constraints = satisfied_constraints + 1
...
if __name__ == '__main__':
    ...
    np.save('./running_results_new_cnn6_cifar_50MB_2.npy', record_results)
