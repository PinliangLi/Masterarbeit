...
if __name__ == '__main__':
    ...
    init_c_training_time = init_c_training_time - 25
    init_c_model_size = init_c_model_size - 500
    ...
    for _ in range(n_iterations + 1):
        ...
        c_training_time = c_training_time - 25
        c_model_size = c_model_size - 500
        print(c_training_time, c_model_size)
        #if (training_time < 125) and (model_size < 20):
        #if (training_time < 200):
        if (training_time < 25):
    ...
    np.save('./running_results_bo_cnn6_cifar_50MB_2.npy', record_results)
