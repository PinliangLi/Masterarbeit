...
n_results = np.load('./running_results_aggregation.npy', allow_pickle=True)
...
ax.set_title("compare original and new method when use two constraints")  # Add a title to the axes.
ax.legend()
plt.show()