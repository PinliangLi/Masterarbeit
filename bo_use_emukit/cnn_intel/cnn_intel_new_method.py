...
def evaluate(params):
    ...
    train_data, valid_data = train_test_split(train_dataset, train_size=config['num_training_data'], test_size=2000,
    ...
    if training_time < 500:
        constraint_value = constraint_value + (training_time - 500)
