...
if __name__ == '__main__':
    ...
    init_c_training_time = init_c_training_time - 1
    ...
    for _ in range(n_iterations + 1):
        ...
        c_training_time = c_training_time - 1
        c_model_size = c_model_size - 0.5
        print(c_training_time, c_model_size)
        if (training_time < 1) and (model_size < 0.5):
    ...
    np.save('./running_results_origin_cnn_FashionMNIST_1_0.5_1.npy', record_results)
