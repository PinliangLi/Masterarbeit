...
if __name__ == '__main__':
    ...
    init_c_training_time = init_c_training_time - 0.2
    #init_c_model_size = init_c_model_size - 2.5
    ...
    for _ in range(n_iterations + 1):
        ...
        c_training_time = c_training_time - 0.2
        c_model_size = c_model_size - 2.5
        print(c_training_time, c_model_size)
        #if (training_time < 10) and (model_size < 2.5):
    ...
    np.save('./running_results_origin_cnn_FashionMNIST_10_2.5_1.npy', record_results)
